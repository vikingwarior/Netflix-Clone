...
import HeaderAccountOptionsDropdown from "./HeaderAccountOptionsDropdown";

const Header = () => {
  const browseOptions = [
    { label: "Home", url: "../../../browse", id: "home-option" },
    { label: "AI Recommendations", url: "../../../browse/suggest", id: "bard-recommendations" },
  ];
  ...
  return (
    <div className="fixed z-20 w-screen flex justify-between align-middle items-center font-medium py-1 bg-gradient-to-b from-black text-white">
      ...
      <div className="flex items-center justify-start">
        <div id="header-search-div" className="mr-7 cursor-pointer">
          <svg
        ...
        <div id="header-notification-div" className="mr-7 cursor-pointer">
