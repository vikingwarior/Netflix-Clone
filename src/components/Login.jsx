...
const Login = () => {
  ...
  const [hideInvalidPasswordMessage, setHideInvalidPasswordMessage] = useState(true);
    ...
    <div className="login-UI">
      ...
      >
        ...
        <input
          ...
          className="p-4 my-3 w-4/5 placeholder:text-white rounded-lg"
        />
        <h3 className="text-red-600 text-left mx-12 my-0" hidden={hideInvalidEmailMessage}>Invalid Email</h3>
        <input
          type="password"
          ref={password}
          ...
          className="p-4 my-3 w-4/5 placeholder:text-white rounded-lg"
        />
        <h3 className="text-red-600 text-left mx-12 my-0" hidden={hideInvalidPasswordMessage}>Invalid Password</h3>
